...
//	    
	if (name == 'STEWARTBY MEMBER AND WEYMOUTH MEMBER (UNDIFFERENTIATED) - MUDSTONE') {name = 'STEWARTBY MEMBER AND WEYMOUTH MEMBER (UNDIFFERENTIATED) - MUDSTONE<br />OXFORD CLAY FORMATION'};
  	if (name == 'PETERBOROUGH MEMBER - MUDSTONE') {name = 'PETERBOROUGH MEMBER - MUDSTONE<br />OXFORD CLAY FORMATION'};
	if (name == 'MOHUNS PARK MUDSTONE BED - MUDSTONE') {name = 'MOHUNS PARK MUDSTONE BED - MUDSTONE<br />PETERBOROUGH MEMBER<br />OXFORD CLAY FORMATION'};
        if (name == 'CORNBRASH FORMATION - LIMESTONE') {name = 'CORNBRASH FORMATION - LIMESTONE<br />GREAT OOLITE GROUP'};
        if (name == 'FOREST MARBLE FORMATION - LIMESTONE') {name = 'FOREST MARBLE FORMATION - LIMESTONE<br />GREAT OOLITE GROUP'};
	if (name == 'FOREST MARBLE FORMATION - MUDSTONE') {name = 'FOREST MARBLE FORMATION - MUDSTONE<br />GREAT OOLITE GROUP'}; 
	if (name == 'FOREST MARBLE FORMATION - SANDSTONE') {name = 'FOREST MARBLE FORMATION - SANDSTONE<br />GREAT OOLITE GROUP'};
	if (name == 'FROME CLAY FORMATION - MUDSTONE') {name = 'FROME CLAY FORMATION - MUDSTONE<br />GREAT OOLITE GROUP'};
	if (name == 'FROME CLAY FORMATION - MUDSTONE, SHELLY') {name = 'FROME CLAY FORMATION - MUDSTONE, SHELLY<br />GREAT OOLITE GROUP'};    
	if (name == "UPPER FULLER'S EARTH MEMBER - MUDSTONE") {name = "UPPER FULLER'S EARTH MEMBER - MUDSTONE<br />GREAT OOLITE GROUP"};
	if (name == "FULLER'S EARTH ROCK MEMBER - LIMESTONE") {name = "FULLER'S EARTH ROCK MEMBER - LIMESTONEE<br />GREAT OOLITE GROUP"};
	if (name == "LOWER FULLER'S EARTH MEMBER - MUDSTONE") {name = "LOWER FULLER'S EARTH MEMBER - MUDSTONE<br />GREAT OOLITE GROUP"};
	if (name == "FULLER'S EARTH MEMBER - MUDSTONE") {name = "FULLER'S EARTH MEMBER - MUDSTONE<br />GREAT OOLITE GROUP"};
	if (name == "FULLER'S EARTH FORMATION - MUDSTONE, CALCAREOUS") {name = "FULLER'S EARTH FORMATION - MUDSTONE, CALCAREOUS<br />GREAT OOLITE GROUP"};
//
	if (name == 'BLUE ANCHOR FORMATION - MUDSTONE') {name = name + '<br />MERCIA MUDSTONE GROUP'}; 
	if (name == 'BRANSCOMBE MUDSTONE FORMATION - MUDSTONE') {name = name + '<br />MERCIA MUDSTONE GROUP'; age = 'NORIAN'};
	if (name == 'ARDEN SANDSTONE FORMATION - MUDSTONE AND SANDSTONE, INTERBEDDED') {name = name + 'ARDEN SANDSTONE FORMATION (DUNSCOMBE MUDSTONE FORMATION) - MUDSTONE AND SANDSTONE, INTERBEDDED - MUDSTONE<br />MERCIA MUDSTONE GROUP'};
	if (name == 'SIDMOUTH MUDSTONE FORMATION - MUDSTONE') {name = name + '<br />MERCIA MUDSTONE GROUP'; age = 'LADINIAN'};
	if (name == 'HELSBY SANDSTONE FORMATION - SANDSTONE') {name = name + 'ARDEN SANDSTONE FORMATION (HELSBY SANDSTONE FORMATION (OTTER SANDSTONE FORMATION) - SANDSTONE<br />SHERWOOD SANDSTONE GROUP'};
	if (name == 'CHESTER FORMATION - CONGLOMERATE') {name = name + 'CHESTER FORMATION (BUDLEIGH SALTERTON PEBBLE BEDS FORMATION) - CONGLOMERATE<br />SHERWOOD SANDSTONE GROUP'};
