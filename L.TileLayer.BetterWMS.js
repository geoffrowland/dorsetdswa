...
//
	...
	if (name == 'ARDEN SANDSTONE FORMATION - MUDSTONE AND SANDSTONE, INTERBEDDED') {name = 'ARDEN SANDSTONE FORMATION (DUNSCOMBE MUDSTONE FORMATION) - MUDSTONE AND SANDSTONE, INTERBEDDED - MUDSTONE<br />MERCIA MUDSTONE GROUP'};
